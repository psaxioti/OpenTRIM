...
log_file = '/opt/pysrim/XeInUO2.log'
# 2. for my PC
# srim_executable_directory = '/home/george/.local/SRIM-2013'
# output_folder = 'qc'  # os.getcwd()
# log_file = 'FeInFe.log'
...
# %%
ion = Ion('Xe', energy=ionE0, mass=131.904) # Z=54
...
layer = Layer({
    ...
    'O': {
        ...
        'surface': 20.0,
        'mass': 16        
    }}, density=10.97, width=target_thickness*10)
